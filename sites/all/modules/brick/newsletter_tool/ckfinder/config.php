...
//SJA: These must be set for the enviornment. $host and $pathToDir were added by me.
$host = 'newsletters.1btest.org';
$pathToDir = '/uploads/';
$baseDir = '/home/sebastian1b/newsletters.1btest.org/uploads/';
$baseUrl = 'http://' . $host . $pathToDir;
