<?php
// $Id: theme-settings.php,v 1.1 2012/01/25 02:43:38 ubuntu Exp $

function tarski_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['custom']['trim_pager'] = array(
    ...
    '#options' => tarski_generate_array(4, 15, 1, ''),
  );
